...
onload = function() {
  ...
  symbolsPlace.addEventListener( "touchmove", function() {
    changeSymbols.on();
    return false;
  }, false )
  symbolsPlace.addEventListener( "touchend", changeSymbols, false );
  symbolsPlace.addEventListener( "click", insertText, false);
...
function normalizeWidth() {
  it.style.width = screen.width / 1.8 + "px";
}